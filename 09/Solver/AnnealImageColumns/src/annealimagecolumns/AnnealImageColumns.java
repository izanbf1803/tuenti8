...
public class AnnealImageColumns {
	...
	public static void main(String[] args) throws IOException {
		...
		File inFile = new File("o1000.png");
		File outFile = new File("out1000.png");
		if (!inFile.isFile()) {
		...
		try {
			numIterations = Long.parseLong("2000000000");
			if (numIterations <= 0)
		...
		try {
			startTemperature = Double.parseDouble("4000");
